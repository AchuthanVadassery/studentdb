...
<head>
  ...
  <!-- for student_profile blade -->
  <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
  <script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
  <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <!-- (end)for student_profile blade -->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('student.show')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('students.registered')}}" class="nav-link">Registered Students</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
	  ...
	  <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('exam.register')}}" class="nav-link">Add Exam</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Student Master</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
